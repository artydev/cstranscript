/**
 * Ce fichier gère le processus de découpage et de traitement des fichiers audio en morceaux.
 * Il utilise des événements Server-Sent Events pour mettre à jour l'interface utilisateur en temps réel pendant le traitement des fichiers.
 * Le script divise un fichier audio en morceaux de taille spécifiée, traite chaque morceau, et met à jour la progression du traitement dans l'interface utilisateur.
 */ 
...
(function () {
    ...
    // max ~8x pour les entrées basse qualité (32kbps).
    ...
    async function lireSessionSSE(sessionSseUrl, externalSignal) {
        ...
        // Combiner le signal de timeout et le signal externe (erreur chunk)
        // AbortSignal.any() est disponible dans les navigateurs modernes (2023+)
        const signal = typeof AbortSignal.any === 'function'
            ? AbortSignal.any([timeoutController.signal, externalSignal])
            : externalSignal; // fallback — timeout interne ignoré mais signal externe fonctionne
